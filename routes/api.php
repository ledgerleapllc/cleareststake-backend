...
// Route::get('/fix-price-data', 'APIController@fixPriceData');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:api']], function() {
	...
	Route::get('/user/{userId}/export-csv', 'AdminController@downloadUserTransctionCsv');
	Route::get('/cspr-price', 'AdminController@getCSPRPrice');
	...
	Route::post('/fund-sale', 'AdminController@fundSale');
});
...
Route::group(['prefix' => 'common', 'middleware' => ['auth:api']], function() {
	...
	Route::get('/transactions/export-csv', 'AdminController@downloadTransactionCSV2');
});
